...
class DayOrNightPlayer(Player, ABC):
    ...
    def print_stats(self):
        num_wins = self.__stats[DayOrNightResult.WIN]
        print(
    ...
    def event_result(self, pos: int, result: DayOrNightResult):
